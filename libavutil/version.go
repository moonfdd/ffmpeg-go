...
//const LIBAVUTIL_VERSION_INT =  AV_VERSION_INT(LIBAVUTIL_VERSION_MAJOR, \
//LIBAVUTIL_VERSION_MINOR, \
//LIBAVUTIL_VERSION_MICRO)
const LIBAVUTIL_VERSION_INT = LIBAVUTIL_VERSION_MAJOR<<16 | LIBAVUTIL_VERSION_MINOR<<8 | LIBAVUTIL_VERSION_MICRO

//const LIBAVUTIL_VERSION   =    AV_VERSION(LIBAVUTIL_VERSION_MAJOR,     \
//LIBAVUTIL_VERSION_MINOR,     \
//LIBAVUTIL_VERSION_MICRO)
const LIBAVUTIL_BUILD = LIBAVUTIL_VERSION_INT

//const LIBAVUTIL_IDENT     =    "Lavu" AV_STRINGIFY(LIBAVUTIL_VERSION)
var LIBAVUTIL_IDENT = fmt.Sprintf("Lavu%d.%d.%d", LIBAVUTIL_VERSION_MAJOR, LIBAVUTIL_VERSION_MINOR, LIBAVUTIL_VERSION_MICRO)
