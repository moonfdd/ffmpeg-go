...
//未测试
func AvVkFrameAlloc() (res *AVVkFrame, err error) {
	var t uintptr
	t, _, _ = ffcommon.GetAvutilDll().NewProc("av_vk_frame_alloc").Call()
	if err != nil {
		//return
	}
	res = (*AVVkFrame)(unsafe.Pointer(t))
	return
}
...
//未测试
func AvVkfmtFromPixfmt(p ffconstant.AVPixelFormat) (res *AVVkFrame, err error) {
	var t uintptr
	t, _, _ = ffcommon.GetAvutilDll().NewProc("av_vkfmt_from_pixfmt").Call()
	if err != nil {
		//return
	}
	res = (*AVVkFrame)(unsafe.Pointer(t))
