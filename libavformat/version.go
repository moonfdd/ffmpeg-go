...
//const LIBAVFORMAT_VERSION_INT =AV_VERSION_INT(LIBAVFORMAT_VERSION_MAJOR, \
//LIBAVFORMAT_VERSION_MINOR, \
//LIBAVFORMAT_VERSION_MICRO)
const LIBAVFORMAT_VERSION_INT = LIBAVFORMAT_VERSION_MAJOR<<16 | LIBAVFORMAT_VERSION_MINOR<<8 | LIBAVFORMAT_VERSION_MICRO

//const LIBAVFORMAT_VERSION  =   AV_VERSION(LIBAVFORMAT_VERSION_MAJOR,   \
//LIBAVFORMAT_VERSION_MINOR,   \
//LIBAVFORMAT_VERSION_MICRO)
//const LIBAVFORMAT_BUILD     =  LIBAVFORMAT_VERSION_INT
//
//const LIBAVFORMAT_IDENT    =   "Lavf" AV_STRINGIFY(LIBAVFORMAT_VERSION)
var LIBAVUTIL_IDENT = fmt.Sprintf("Lavf%d.%d.%d", LIBAVFORMAT_VERSION_MAJOR, LIBAVFORMAT_VERSION_MINOR, LIBAVFORMAT_VERSION_MICRO)
